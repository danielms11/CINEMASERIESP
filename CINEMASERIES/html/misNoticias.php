...
include('../php/eliminarNoticia.php')
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <section>
        ...
        <article class="mt-2">
            ...
            if (isset($_POST['idNoticia'])) {
                ...
                eliminarNoticia($pdo, $idNoticia);
            }

            $resultadoTarjetaPersonal = mostrarTarjetaPersonal($consultaTarjeta, $pdo);

            echo $resultadoTarjetaPersonal;
            ?>
        </article>
    </section>
