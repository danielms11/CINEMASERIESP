...
<head>
    ...
    <title>CINEMASERIES-Inicio</title>
</head>
...
<body>
    ...
    $consultaCarousel = "SELECT titulo, foto, categoria_principal, id_noticia
    ...
    <section>
        <div class="container">
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <?php
                    $mostrarCarousel = mostrarCarousel($consultaCarousel, $pdo);

                    echo $mostrarCarousel;
                    ?>
                </div>
        ...
        <article class="mt-3">
            <?php
            $mostrarTarjeta = mostrarTarjeta($consultaTarjeta, $pdo);
